...
* Source data: The folder contains the ploting code for reproducing the figures in the paper : Han, S., Cai J., Yang J. et al (2021). Time-varying optimization of COVID-19 vaccine prioritization in the context of limited vaccination capacity.
